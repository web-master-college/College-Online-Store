...
import { notifyMessage, sendContactForm } from '../../utils';
...
export default function ContactUs() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (result.success) {
        notifyMessage('Message sent successfully!');
        navigate('/thank-you', { 
          state: {
        ...
        notifyMessage('Failed to send message. Please try again.');
      }
    } catch (error) {
