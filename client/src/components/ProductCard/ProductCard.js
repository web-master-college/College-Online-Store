...
export default function ProductCard(props) {
  return (
    ...
    <div
      ...
      <div className="h-[190px] overflow-hidden rounded-lg">
        <a href="#">
          <img
            ...
            src={props.product.images && props.product.images.length ? props.product.images[0] : 'img/cards/notebooks/note_1.jpg'}
            alt="product" />
        </a>
      </div>
      ...
      <div className="my-1">
        {props.product.discount > 0 && <span className="text-lg font-bold">${props.product.price - ((props.product.discount / 100)  * props.product.price)}</span>}
